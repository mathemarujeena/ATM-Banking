...
class UserBankAccount(models.Model):
    ...
    fingerprint_images = models.ImageField(blank = True, null= True, upload_to="images/")
    ...
    #     self.account_no = self.id + settings.ACCOUNT_NUMBER_START_FROM
    #     super(UserBankAccount, self).save(*args, **kwargs)

class Images(models.Model):
    image = models.ImageField(upload_to='checkimages/',blank = True, null= True)
